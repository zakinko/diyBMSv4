...
## Difference from V490

Same board, same firmware.  Only the fitted parts differ: the ones that could
no longer be ordered are replaced, and a few move to parts that cost nothing to
set up.  See the pull request that introduced this directory for the full list
and the reasoning.
